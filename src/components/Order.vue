        ...
        <div class="container pt-5">
          <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              <h3>Kargonuz bizimle güvende</h3>
              <p>
                Sektöründe tecrübeli saha ekipleri ile teknolojinin gücünü bir
                araya getirerek sizlere en üst kalitede teslimat deneyimi
                sunuyoruz.
              </p>
              <ul class="pb-5">
                <li>
                  <i class="bx bx-check-double"></i> Zamanın değerini bilen
                  müşteri odaklı teslimat modeliyle taşımacılık sektöründe fark
                  yaratıyoruz.
                </li>
              </ul>
            </div>
    ...
    >
      <div class="container text-center" id="footer-part">
        ...
        <small
          ...
          Youtube: Dunder Mifflin Inc.</small
        >
